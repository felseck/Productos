...
>
    ...
    <!-- Modal backdrop -->
                                            ...
                                            class="fixed inset-0 bg-slate-900 bg-opacity-30 z-50 transition-opacity" x-show="show"
                                             x-transition:enter="yh yx yy" x-transition:enter-start="opacity-0" x-transition:enter-end="yr" x-transition:leave="yh yx yg" x-transition:leave-start="yr" x-transition:leave-end="opacity-0" aria-hidden="true" style="display: none;"></div>
       ...
       <!-- Modal dialog -->
                                            ...
                                            class="bg-white rounded shadow-lg  {{ $maxWidth }} w-full max-h-full" 
