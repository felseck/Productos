            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative inline-flex" x-data="{ open: false }">
                    ...
                    >
                        ...
                        <ul>
                            <li>
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="{{ route('profile.show') }}" @click="open = false" @focus="open = true" @focusout="open = false">{{__('Profile') }}</a>
                            </li>
                            <li>
                            ...
                            <form method="POST" action="{{ route('logout') }}" x-data>
                                ...
                                <a class="font-medium text-sm text-indigo-500 hover:text-indigo-600 flex items-center py-1 px-3" href="#" @click.prevent="$root.submit();" @click="open = false" @focus="open = true" @focusout="open = false">{{ __('Sign Out') }}</a>
                            </form>
                        </li>
                        </ul>                
                    </div>
